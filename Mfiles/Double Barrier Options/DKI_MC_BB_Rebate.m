...
%does not happen before maturity using Monte Carlo simulation 
%with Brownian Bridge,No Variance Reduction involved in this program.
function [price,std,CI]=DKI_MC_BB_Rebate(S0,r,T,sigma,H,L,N_path)
N=64;
deltaT=T/N;
